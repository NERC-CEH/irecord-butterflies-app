      ...
      fromTo={[
        {
          ...
          toValue: 'var(--color-primary)',
        },
        {
          property: 'background',
          fromValue: 'rgba(var(--color-primary-800-rgb),0.1)',
          toValue: '',
        },
      ]}
    >
      <span className="absolute left-0 top-0 flex h-full w-full items-center justify-center text-primary">
        {value}
      </span>
    </CreateAnimation>
  );
